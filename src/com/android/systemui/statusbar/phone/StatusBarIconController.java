...
public class StatusBarIconController implements Tunable {
    ...
    private KeyButtonView mHomeView;
    private KeyButtonView mRecentView;
    private KeyButtonView mBackView;
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        mRecentView = (KeyButtonView) statusBar.findViewById(R.id.recent_apps007);
        mHomeView = (KeyButtonView) statusBar.findViewById(R.id.home);
        mBackView = (KeyButtonView) statusBar.findViewById(R.id.back);
...
//                mIconSize-5, mIconSize));
    ...
    private void applyIconTint() {
        ...
        if (mBackView != null) {
            mBackView.setImageTintList(ColorStateList.valueOf(mIconTint));
        }
        applyNotificationIconsTint();
    }
