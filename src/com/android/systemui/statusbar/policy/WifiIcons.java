...
*/    
    static final int[][] WIFI_SIGNAL_STRENGTH = {
            { R.drawable.statusbar_icon_wifi_0,
              R.drawable.statusbar_icon_wifi_1,
              R.drawable.statusbar_icon_wifi_2,
              R.drawable.statusbar_icon_wifi_3 },
            { R.drawable.statusbar_icon_wifi_0,
              R.drawable.statusbar_icon_wifi_1,
              R.drawable.statusbar_icon_wifi_2,
              R.drawable.statusbar_icon_wifi_3 }
    ...
    static final int QS_WIFI_NO_NETWORK = R.drawable.ic_qs_wifi_no_network;
    static final int WIFI_NO_NETWORK = R.drawable.statusbar_icon_wifi_0;
