...
public class WifiSignalController extends
    ...
    public WifiSignalController(Context context, boolean hasMobileData,
            CallbackHandler callbackHandler, NetworkControllerImpl networkController,Handler mHandler) {
		...
		Log.d(TAG, "WifiSignalController mUIHandler : " + mUIHandler);
		mUIHandler = mHandler;
    ...
    public void notifyListeners() {
        ...
        /// M:for wifi icons visibilty when receive no wifi description @ {
        final Resources r = mContext.getResources();
        if(contentDescription.equals(r.getString(R.string.accessibility_no_wifi)))
        {
            Log.d(TAG, "Wifi is disconnected,no need to show");
            wifiVisible = false;
        }
        /// @ }
        ...
        if (action.equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
			...
			if(mUIHandler != null){
				...
				if(state == WifiManager.WIFI_STATE_ENABLED){
					msg1.what = PhoneStatusBar.MSG_UPDATE_QS_WIFI;
					msg1.arg1 = 1;
			...
			Log.d(TAG,"mCurrentState.rssi = " + mCurrentState.rssi);
			Log.d(TAG,"mCurrentState.level = " + mCurrentState.level);
        }
