...
public class NetworkControllerImpl extends BroadcastReceiver
     ...
     */
    public NetworkControllerImpl(Context context, Looper bgLooper,Handler handler) {
		...
		Log.d(TAG, "NetworkControllerImpl mUIHandler : " + handler);
		mUIHandler = handler;
    }
    ...
    NetworkControllerImpl(Context context, ConnectivityManager connectivityManager,
            ...
            SubscriptionDefaults defaultsHandler,Handler handler) {
        mContext = context;
        mConfig = config;
        ...
        mWifiSignalController = new WifiSignalController(mContext, mHasMobileDataFeature,
                mCallbackHandler, this,mUIHandler);
    ...
    void handleIMSAction(Intent intent) {
        ...
        int imsSubId = getSubIdUsingPhoneId(phoneId);
    ...
    public int getSubIdUsingPhoneId(int phoneId){
        int subId = -1;
        if (mIsTest) {
            subId = (phoneId == 0 ? SubscriptionManager.DEFAULT_SUBSCRIPTION_ID :
                SubscriptionManager.DEFAULT_SUBSCRIPTION_ID -1);
        } else {
