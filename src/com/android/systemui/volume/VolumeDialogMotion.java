...
public class VolumeDialogMotion {
    ...
    private static final int PRE_DISMISS_DELAY = 5;
    ...
    private void startShowAnimation() {
        ...
        mChevron.animate()
                .alpha(1)
                .setStartDelay(scaledDuration(5))
                .setDuration(scaledDuration(15))
