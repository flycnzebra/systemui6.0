...
public class ImageWallpaper extends WallpaperService {
    ...
    boolean mRotationChanged = false;
    ...
    class DrawableEngine extends Engine {
        ...
        void updateSurfaceSize(SurfaceHolder surfaceHolder, DisplayInfo displayInfo) {
            ...
            if (DEBUG) {
                Log.d(TAG, "mBackgroundWidth/Height: " + mBackgroundWidth
                    + "/" + mBackgroundHeight);
            }
            ...
            if (DEBUG) {
                Log.d(TAG, "surfaceWidth/Height: " + surfaceWidth + "/" + surfaceHeight);
            }
            ...
            if (frame != null) {
                ...
                if (surfaceWidth == dw && surfaceHeight == dh && !mRotationChanged) {
                    return;
                }
            }
            ...
            try {
                ...
                if (newRotation != mLastRotation) {
                    // Update surface size (if necessary)
                      if (DEBUG) {
                        Log.d(TAG, "Rotation changed : " + mLastRotation + " --> " + newRotation);
                    }
