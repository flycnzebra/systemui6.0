...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    private class BrightnessObserver extends ContentObserver {
        ...
        Log.d(TAG,"onChanged selfChange :"+ selfChange+ " uri: " + uri);
    ...
    public void onChanged(ToggleSlider view, boolean tracking, boolean automatic, int value,
		...
		Log.d(TAG,"onChanged mAutomatic :"+ mAutomatic+ " mExternalChange: " + mExternalChange);
        ...
        if (!mAutomatic) {
            ...
            if(true){
                AsyncTask.execute(new Runnable() {
                        public void run() {
							Log.d(TAG,"putIntForUser SCREEN_BRIGHTNESS :"+val);
    ...
    private void setBrightnessAdj(float adj) {
		Log.d(TAG,"setBrightnessAdj" + adj);
        try {
            //mPower.setTemporaryScreenAutoBrightnessAdjustmentSettingOverride(adj);
            mPower.setTemporaryScreenBrightnessSettingOverride((int)adj);
        } catch (RemoteException ex) {
        }
    }
    ...
    private void updateSlider() {
        ...
        if (mAutomatic) {
            ...
            value = Settings.System.getIntForUser(mContext.getContentResolver(),
                    ...
                    UserHandle.USER_CURRENT);
			Log.d(TAG,"updateSlider SCREEN_BRIGHTNESS value:" + value );
