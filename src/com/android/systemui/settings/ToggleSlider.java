...
public class ToggleSlider extends RelativeLayout {
	...
	public static final String BROADCAST_BACKLIGHT_CHANGED = "com.android.systemui.backlight.changed";
    ...
    public ToggleSlider(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBacklightValue = (TextView) findViewById(R.id.backlight_value);
...
*/
    private final OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
			...
			Log.d(TAG,"onProgressChanged progress :"+ progress+ " fromUser: " + 
				fromUser + " value:" + value + " mMinimumBacklight:" + mMinimumBacklight);
			mBacklightValue.setText("" + value);
		    
			if (mListener != null) {
                mListener.onChanged(
                        ToggleSlider.this, mTracking, true, progress, false);
				if(fromUser){
					Intent intent = new Intent();
            		intent.setAction(BROADCAST_BACKLIGHT_CHANGED);
        ...
        public void onStartTrackingTouch(SeekBar seekBar) {
            ...
            if (mListener != null) {
                mListener.onChanged(ToggleSlider.this, mTracking, true,
